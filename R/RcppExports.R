...
loadVars <- function(X, Y, V, D, nPredictors, cType = 1L, mSplit = 15L, mBucket = 10L, cp = 0.01, argStep = 1) {
    .Call('_fTree_loadVars', PACKAGE = 'fTree', X, Y, V, D, nPredictors, cType, mSplit, mBucket, cp, argStep)
}
